...
class RightDoorVariation extends Car
{
    ...
    initBuffers(){
        ...
        this.frontDoor1 = new CubeTransparent(this.gl, this.camera, {red:this.doorHandle.red, green: this.doorHandle.green, blue: this.doorHandle.blue, alpha: this.transparency}, false);
