...
class Chassis extends Car {
    ...
    initBuffers(){
        ...
        this.engine = new MetalCube(this.gl, this.camera,{red:0.333, green: 0.235, blue:0.105, alpha:1},  false);
        this.engine.init('my-vertex-shader', 'my-fragment-shader');

        this.radiator = new ShinyCube(this.gl, this.camera,{red:0.333, green: 0.235, blue:0.204, alpha:1},  false);
    ...
    draw(elapsed, modelMatrix){
        ...
        //høyre
        this.stack.peekMatrix(modelMatrix);
        modelMatrix.translate(1.3, -102, 1.5);
        modelMatrix.scale(0.1, 110, 0.1);
