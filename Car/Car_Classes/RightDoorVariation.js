...
class RightDoorVariation extends Car
{
    ...
    initBuffers(){
        this.frontDoor = new CubeTransparent(this.gl, this.camera, {red:0.400, green: 0.0, blue: 0.0, alpha: this.transparency}, false);
        this.frontDoor.init('my-vertex-shader', 'my-fragment-shader');

        this.frontDoor1 = new CubeTransparent(this.gl, this.camera, {red:0.2, green: 0.0, blue: 0.4, alpha: this.transparency}, false);
