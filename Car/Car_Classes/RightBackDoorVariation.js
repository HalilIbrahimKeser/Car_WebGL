...
class RightBackDoorVariation extends Car {
    ...
    initBuffers(){
        this.door = new CubeTransparent(this.gl, this.camera, {red:0.400, green: 0.0, blue: 0.0, alpha: this.transparency}, false);
        this.door.init('my-vertex-shader', 'my-fragment-shader');

        this.handle = new CubeTransparent(this.gl, this.camera, {red:0.3, green: 0.0, blue: 0.4, alpha: this.transparency}, false);
